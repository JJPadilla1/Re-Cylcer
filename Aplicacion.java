	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				aplicacion1.setNewColecta(String.valueOf(comboBox.getSelectedItem()),String.valueOf(comboBox_4.getSelectedItem()), String.valueOf(comboBox_1.getSelectedItem()));;
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				aplicacion1.setNewVoluntariado(String.valueOf(comboBox_3.getSelectedItem()),String.valueOf(comboBox_5.getSelectedItem()) , String.valueOf(comboBox_2.getSelectedItem()));
		...
		comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"23 de Abril", "24 de Abril", "25 de Abril"}));
		comboBox_4.setBounds(377, 102, 96, 19);
		panel.add(comboBox_4);
		
		comboBox_5 = new JComboBox();
		comboBox_5.setModel(new DefaultComboBoxModel(new String[] {"23 de Abril", "24 de Abril", "25 de Abril"}));
		comboBox_5.setBounds(652, 102, 96, 19);
